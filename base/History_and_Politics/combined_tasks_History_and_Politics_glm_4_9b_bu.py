...
def main():
    ...
    configure_logging('/public/chengweiwu/mingyang/logs/1115/combined_tasks_History_and_Politics_glm-4-9b_bu.log')

    tokenizer, model, device = load_model(model_path)

    tasks = [
        {
            'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/kg_submit/kg_all_Humanities_and_Society_random1w1_head1w_dev2k.jsonl',
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/kg_output_Humanities_and_Society_glm-4-9b.jsonl',
            'template': kg_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/kg_output_Nature_and_Environment_glm-4-9b.jsonl',
            'template': kg_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/qa_output_Technology_and_Economics_glm-4-9b.jsonl',
