...
def main():
    ...
    configure_logging('/public/chengweiwu/mingyang/logs/1117/combined_tasks_History_and_Politics_phi_2_bu.log')

    tokenizer, model, device = load_model(model_path)

    tasks = [
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/kg_submit/kg_all_History_and_Politics_random1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1117/kg_output_History_and_Politics_phi_2.jsonl',
         'template': kg_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1117/kg_output_Humanities_and_Society_phi_2.jsonl',
            'template': kg_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1117/kg_output_Technology_and_Economics_phi_2.jsonl',
            'template': kg_template}
    ]
