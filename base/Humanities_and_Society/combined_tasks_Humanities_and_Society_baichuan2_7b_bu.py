    ...
    with open(input_file_path, 'r', encoding='utf-8') as infile, open(output_file_path, 'w', encoding='utf-8') as outfile:
        for line in infile:
            ...
            if inputs['input_ids'].numel() == 0:
                logging.error(f"Empty input for query: {query}")
                continue
            gen_kwargs = {"max_new_tokens": 2500, "repetition_penalty": 1.1}
            with torch.no_grad():
                outputs = model.generate(**inputs, **gen_kwargs)
                if outputs.shape[0] == 0:
                    logging.error("Model did not generate any output.")
                    continue
...
def main():
    ...
    configure_logging('/public/chengweiwu/mingyang/logs/1115/combined_tasks_Humanities_and_Society_baichuan2_7b_bu.log')

    tokenizer, model, device = load_model(model_path)

    tasks = [
        {'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/textGen_submit/textGen_all_Humanities_and_Society_random_1w1_head1w_dev2k.jsonl',
         'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/text_gen_output_Humanities_and_Society_baichuan2_7b.jsonl',
         'template': text_gen_template},
        {
            'input_file': '/public/chengweiwu/mingyang/data/input_data/submit/textGen_submit/textGen_all_Nature_and_Environment_random_1w1_head1w_dev2k.jsonl',
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/text_gen_output_Nature_and_Environment_baichuan2_7b.jsonl',
            'template': text_gen_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/text_gen_output_Technology_and_Economics_baichuan2_7b.jsonl',
            'template': text_gen_template}
    ]
