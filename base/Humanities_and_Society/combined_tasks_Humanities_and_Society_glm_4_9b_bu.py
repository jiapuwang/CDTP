...
def main():
    ...
    configure_logging('/public/chengweiwu/mingyang/logs/1115/combined_tasks_Humanities_and_Society_glm-4-9b_bu.log')
    ...
    tasks = [
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/text_gen_output_History_and_Politics_glm-4-9b.jsonl',
            'template': text_gen_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1115/text_gen_output_Nature_and_Environment_glm-4-9b.jsonl',
            'template': text_gen_template}
    ]
