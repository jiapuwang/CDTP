    ...
    with open(input_file_path, 'r', encoding='utf-8') as infile, open(output_file_path, 'w', encoding='utf-8') as outfile:
        for line in infile:
            ...
            with torch.no_grad():
                ...
                if outputs.size(0) == 0:  # 检查输出的大小
                    logging.error("Model generated no outputs for query: {}".format(query))
                    continue
...
def main():
    ...
    configure_logging('/public/chengweiwu/mingyang/logs/1117/combined_tasks_Humanities_and_Society_phi_2_bu.log')
    ...
    tasks = [
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1117/text_gen_output_History_and_Politics_phi_2.jsonl',
            'template': text_gen_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1117/text_gen_output_Humanities_and_Society_phi_2.jsonl',
            'template': text_gen_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1117/text_gen_output_Nature_and_Environment_phi_2.jsonl',
            'template': text_gen_template},
        {
            ...
            'output_file': '/public/chengweiwu/mingyang/data/output_data/1117/text_gen_output_Technology_and_Economics_phi_2.jsonl',
            'template': text_gen_template}
    ]
