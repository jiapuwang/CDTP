...
# 配置日志记录器
logging.basicConfig(
    filename='/public/chengweiwu/mingyang/logs/1117/kg_History_and_Politics_yi_9b.log',
    level=logging.INFO,
...
ckpt = torch.load('/public/chengweiwu/mingyang/sft/checkpoints/Yi-9B_kg_History_and_Politics/epoch-2-333-hf/pytorch_model.bin')
...
output_file_path = '/public/chengweiwu/mingyang/data/output_data/1117/kg_output_History_and_Politics_yi_9b.jsonl'
...
with open(input_file_path, 'r', encoding='utf-8') as input_file, \
    ...
    for line in input_file:
        ...
        if not query.strip():
            logging.error("Query is empty, skipping this entry.")
            continue
        ...
        with torch.no_grad():
            ...
            if outputs.size(0) == 0:
                logging.error("Model generated empty output for query: {}".format(query))
                continue
